...
In the API, a `Voter` structure carries a brief information about a Top.gg user who has voted for an entity in Top.gg. It is structured like this:
...
In the API, a `Reviews` structure carries a brief information about an Top.gg entity's user reviews. It is structured like this:
...
<Tabs>
  <TabItem value="table" label="Table" default>
    ...
    | `count`        | `string`      | The amount of user reviews received by this entity.       |
  </TabItem>
  <TabItem value="json" label="JSON example">
    ```json
    {
